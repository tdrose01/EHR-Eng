  ...
  <div class="min-h-screen bg-gray-900 text-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex gap-6">
        <AppSidebar />
        <main class="flex-1">
          <h2 class="text-2xl font-bold text-blue-400 mb-4">Add Patient</h2>
          <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <form @submit.prevent="addPatient">
              ...
              <div class="flex gap-2 mt-6">
                <button type="submit" class="btn bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Add Patient</button>
...
function addPatient() {
  fetch('http://localhost:8002/api/patients', {
    ...
    .then(data => {
      if (data.success) {
        statusMessage.value = 'Patient added successfully!'
    ...
    .catch(error => {
      statusMessage.value = error.message || 'Error adding patient'
